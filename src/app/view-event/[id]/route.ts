...
export async function GET(
  ...
  const appUrl = `quickcourt://view-event/${id}`;
  const webUrl = `https://quickcourt.co/view-event/${id}`;
...
<head>
  ...
  <!-- Open Graph -->
  <meta property="og:title" content="QuickCourt Event" />
  <meta property="og:description" content="Join this sports event on QuickCourt" />
